...
export class PromptError extends Error {
  ...
  static templateNotFound(id: string, details?: any): PromptError {
    return new PromptError(PromptErrorType.TEMPLATE_NOT_FOUND, `Template with ID '${id}' not found`, details);
  }
  ...
  static invalidTemplate(message: string, details?: any): PromptError {
    return new PromptError(PromptErrorType.INVALID_TEMPLATE, `Invalid template: ${message}`, details);
  }
  ...
  static variableValidationFailed(errors: ValidationError[], details?: any): PromptError {
    return new PromptError(PromptErrorType.VARIABLE_VALIDATION_FAILED, `Variable validation failed: ${errors.map(e => e.message).join(', ')}`, {
      errors,
      ...details,
    });
  }
  ...
  static versionNotFound(templateId: string, version: string, details?: any): PromptError {
    return new PromptError(PromptErrorType.VERSION_NOT_FOUND, `Version '${version}' not found for template '${templateId}'`, details);
  }
  ...
  static renderError(message: string, details?: any): PromptError {
    return new PromptError(PromptErrorType.RENDER_ERROR, `Template render error: ${message}`, details);
  }
  ...
  static storageError(message: string, details?: any): PromptError {
    return new PromptError(PromptErrorType.STORAGE_ERROR, `Storage error: ${message}`, details);
  }
  ...
  static cacheError(message: string, details?: any): PromptError {
    return new PromptError(PromptErrorType.CACHE_ERROR, `Cache error: ${message}`, details);
  }
  ...
  static categoryNotFound(id: string, details?: any): PromptError {
    return new PromptError(PromptErrorType.CATEGORY_NOT_FOUND, `Category with ID '${id}' not found`, details);
  }
  ...
  static permissionDenied(action: string, details?: any): PromptError {
    return new PromptError(PromptErrorType.PERMISSION_DENIED, `Permission denied for action: ${action}`, details);
  }
}

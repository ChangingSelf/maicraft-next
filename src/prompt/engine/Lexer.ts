...
export class Lexer {
  ...
  private tokenizeVariable(): void {
    ...
    if (value === null) {
      throw PromptErrorFactory.invalidTemplate(
        `Unclosed variable, expected '${this.config.variableEnd}'`,
  ...
  private tokenizeConditionalStart(): void {
    ...
    if (value === null) {
      throw PromptErrorFactory.invalidTemplate(
        `Unclosed conditional start, expected '${this.config.variableEnd}'`,
        { line: startLine, column: startColumn }
      )
    }
  ...
  private tokenizeLoopStart(): void {
    ...
    if (value === null) {
      throw PromptErrorFactory.invalidTemplate(
        `Unclosed loop start, expected '${this.config.variableEnd}'`,
        { line: startLine, column: startColumn }
      )
    }
  ...
  private tokenizeInclude(): void {
    ...
    if (value === null) {
      throw PromptErrorFactory.invalidTemplate(
        `Unclosed include, expected '${this.config.variableEnd}'`,
        { line: startLine, column: startColumn }
      )
    }
  ...
  private tokenizeComment(): void {
    ...
    if (this.position >= this.input.length) {
      throw PromptErrorFactory.invalidTemplate(
        `Unclosed comment, expected '${this.config.commentEnd}'`,
        { line: startLine, column: startColumn }
      )
    }
  ...
  private isAtSequence(sequence: string): boolean {
    ...
    return this.config.ignoreCase
      ? currentSequence.toLowerCase() === sequence.toLowerCase()
